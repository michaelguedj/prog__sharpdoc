...
function usage 
{
	...
	echo "    the part of <some_file> beginning with \"##\""
	exit 1
}
...
echo -e "\n\n Install " >> README.txt
echo -e "-----------" >> README.txt
echo -e "___$ bash INSTALL.sh\n" >> README.txt


# One assumes that the program was installed via 123tools.
echo -e "\n\n Uninstall " >> README.txt
echo -e "-----------" >> README.txt
echo -e "___$ bash ~/.123/<NAME>/UNINSTALL.sh\n" >> README.txt
